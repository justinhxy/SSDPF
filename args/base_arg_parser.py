...
class BaseArgParser(object):
    def __init__(self):
        ...
        self.parser.add_argument('--model',type=str,default='PENet',
                                    choices=('PENet','PENetClassifier','SSPre','Stage1','CausalImg','CausalTab',\
                                    'only_contrastive','only_causal','cauTab','SSPre2', 'SSPre1_2', 'SSPre1_3'))
        #W
        ...
        self.parser.add_argument('--threshold_size',type=float,default=0)
    ...
    def parse_args(self):
        ...
        #w 加上
        elif args.model=='SSPre1_3' or args.model=='SSPre1_2' or args.model=='SSPre' or args.model=='SSPre2' or args.model=='Stage1' or args.model=='CausalImg' or args.model=='CausalTab'\
        or args.model=='only_contrastive' or args.model=='only_causal' or args.model=='cauTab':
